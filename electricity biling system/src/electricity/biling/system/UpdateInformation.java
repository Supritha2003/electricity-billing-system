...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    JTextField tfaddress, tfstate, tfcity, tfphone;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("update customer set address = '"+address+"', city = '"+city+"', state = '"+state+"', phoneno = '"+phone+"' where meter_no = '"+meter+"'");
